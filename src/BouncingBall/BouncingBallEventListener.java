...
public class BouncingBallEventListener implements GLEventListener,KeyListener, MouseListener {
    ...
    public void display(GLAutoDrawable glAutoDrawable) {
        ...
        String soundStatus = soundManager.isMuted() ? " (Muted)" : " (Sound On)";
        renderText(gl, "Sound: 'M'" + soundStatus, -0.9f, -0.9f);
        renderText(gl, "Pause: 'P'", -0.9f, -0.8f);
    ...
    public void drawBricks() {
        float startX = xMin + 15;
        float startY = yMax - 25;
    ...
    public void drawHearts(GL gl) {
        float heartX = xMin + 10;
        float heartY = yMin + 10;
